...
Product.create!([
  ...
  {title: "Persimmon", price: "0.99", image_url: "https://media.mercola.com/assets/images/foodfacts/persimmons-nutrition-facts.jpg", description: "bright sweetness", supplier_id: 2, availability: true},
  {title: "Pear", price: "2.0", image_url: "https://healthyrise.com/wp-content/uploads/2016/09/Pear-2.jpg", description: "Yellow", supplier_id: 2, availability: true},
  {title: "Apple", price: "3.0", image_url: "https://www.chelanfresh.com/hs-fs/hubfs/Images/honey-crisp-apple-chelan-fresh.png?t=1517307882428&width=238&height=301&name=honey-crisp-apple-chelan-fresh.png", description: "red and yellow", supplier_id: 1, availability: true}
])
